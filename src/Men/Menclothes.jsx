...
import {AddItem,FindTotal,Isinside,CartOn} from '../Redux/Cart'
      ...
      <div className='flex mt-16 ml-40'>
        ...
        <div className='ml-20'>
          ...
          {(typeof(cartitems.find(items=>items.title===cloth.title && items.size===cloth.size))!="undefined")?(
              ...
              onClick={()=>{dispatch(AddItem(cloth)); console.log(cartitems);dispatch(FindTotal());dispatch(CartOn())}}>Add to Cart</div>
          )}
        </div>
      </div>
